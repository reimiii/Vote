...
<body class="font-sans bg-gray-background text-gray-900 text-sm">
    <header class="flex items-center justify-between px-8 py-4">
        ...
        <div class="flex items-center">
            ...
            @endif
            <a href="#">
                <img src="https://www.gravatar.com/avatar/0000000?d=mp" alt="avatar" class="w-10 h-10 rounded-full">
            </a>
        </div>
    </header>
    ...
    <main class="container mx-auto max-w-custom flex">
        <div class="w-70 mr-5">
            Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis consequatur
